    ...
    return (
        <div className={styles.accordionContainer}>
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} sx={{ border: '1px solid #ddd', mb: 1, boxShadow: 'none' }}>
                <AccordionSummary
                    expandIcon={<ExpandCircleDownOutlinedIcon sx={{ fontSize: 32,color: '#000000', }} />}
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} sx={{ border: '1px solid #ddd', mb: 1, boxShadow: 'none' }}>
                ...
                <AccordionDetails >
                    <Typography sx={{ fontSize: 20,color: '#000000', fontWeight: '400', }}>
                        Trabalhamos na gestão das atividades-meios, possibilitando ao cliente dedicação e foco no seu próprio negócio.<br></br><br></br>Fiscalização em todos os postos em que prestamos serviços.<br></br><br></br>Avaliações periódicas de desempenho, boletins de visita e avaliação de qualidade de serviço prestado.<br></br><br></br>Plantão permanente de reservas para atendimentos de substituição, com atendimento telefônico e sistema de rádio para contato com nossos supervisores e coordenadores.<br></br><br></br>Treinamento e reciclagem de todos profissionais.<br></br><br></br>Dispondo de viaturas para atendimento emergencial.
                    </Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} sx={{ border: '1px solid #ddd', mb: 1, boxShadow: 'none' }}>
                ...
                <AccordionDetails>
                    <Typography sx={{ fontSize: 20,color: '#000000', fontWeight: '400', }}>
                        Terceirizar não é apenas entregar à outra entidade a guarda de seu patrimônio, é, sobretudo:<br></br><br></br> Obter mais produtividade em seu próprio negócio<br></br><br></br> Ganhar com transferências das responsabilidades de toda possível ocorrência.<br></br><br></br>Lucrar com a passagem das responsabilidades trabalhistas para o contratado, se livrando da co-responsabilidade, sobre as guias dos impostos mensalmente.
                    </Typography>
                </AccordionDetails>
            </Accordion>
